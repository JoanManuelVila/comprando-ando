    ...
    return (
      <>
        <div className='buttons d-flex justify-content-center mb-5 pb-5'>
          ...
          <button className='btn btn-outline-dark me-2' onClick={() => filterProduct("electronics")}>Tecnologia</button>
        </div>
        {filter.map((product) => {
          return (
            <>
              <div className='col-md-3 mb-4'>
                <div class="card h-100 text-center p-4" key={product.id}>
                  ...
                  <div class="card-body">
                    ...
                    <NavLink to={`/products/${product.id}`} class="btn btn-outline-dark">Llevalo ahora</NavLink>
                  </div>
                </div>
              </div>
            </>
      ...
      <div className='container my-5 py-5'>
        <div className='row'>
          <div className='col-12 mb-5'>
            <h1 className='display-6 fw-bolder text-center'>Nuestros Productos</h1><hr />
          </div>
        </div>
